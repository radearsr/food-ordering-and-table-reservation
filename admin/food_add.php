                ...
                <nav class="navbar navbar-default navbar-fixed" style="background: #4caf50;">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#" style="color: #fff;">Tambah Menu Baru</a>
                        </div>
                                        ...
                                        <form method="post" action="food_add.php" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autofocus name="name" class="form-control" placeholder="Enter food Name"
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="txtarea" class="form-control" placeholder="Enter Food description" name="desc"
                                                            required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label
                                                            style="display: block; border-radius: 5px; letter-spacing: 2px; background: #fff; color: #333; padding: 10px; border: 1px solid #ccc; cursor: pointer; text-align: center; font-size: 15px; font-weight: bold;"
                                                            for="file" class="file_lbl"><i style="font-weight: bold; font-size: 19px;"
                                                                class="pe-7s-upload"></i>Select Image<input type="file" style="display: none;" id="file"
                                                                name="file" required /></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="submit" name="submit" style="background: #4caf50; border: 1px solid #4caf50"
                                                value="Simpan menu" class="btn btn-info btn-fill pull-right" />
